...
//   try {
//     // 1. دریافت تمام داده‌های بدن درخواست
...
//     // 3. ایجاد کاربر جدید با تمام داده‌ها
...
//       user: newUser // ارسال تمام اطلاعات کاربر (اختیاری)
//     });
...
//       error: err.message // فقط برای محیط توسعه
//     });
//   }
// });
// // Route لاگین
...
//     // لاگ برای دیباگ
//     console.log('دریافت داده:', { username, password });
...
//       user: { username: user.username } // ارسال اطلاعات کاربر
//     });
